...
public class SchetsWin : Form {
  ...
  private void veranderAfmeting(object o, EventArgs ea) {
    schetscontrol.Size =
        new Size(this.ClientSize.Width - 70, this.ClientSize.Height - 50);
  ...
  private void afsluiten(object obj, EventArgs ea) { this.Close(); }

  private void onFormClose(object obj, FormClosingEventArgs e) {
    if (this.schetscontrol.Schets.sketchChanged) {
      DialogResult stillclose = MessageBox.Show(
          "Are you sure you want to close without saving?", "Unsaved changes",
  ...
  public SchetsWin() {
    ISchetsTool[] deTools = { new PenTool(),       new LijnTool(),
                              new RechthoekTool(), new VolRechthoekTool(),
                              new CirkelTool(),    new VolCirkelTool(),
                              new TekstTool(),     new GumTool() };
    ...
    schetscontrol.MouseDown += (object o, MouseEventArgs mea) => {
      vast = true;
      this.schetscontrol.Schets.sketchChanged = true;
  ...
  private void maakActieMenu(String[] kleuren) {
    ...
    menuStrip.Items.Add(menu);
    menu.DropDownItems.Add("Save project", null,
                           schetscontrol.Schets.SaveProject);
    menu.DropDownItems.Add("Open project", null, schetscontrol.OpenProject);
    menu.DropDownItems.Add("Export Image", null,
                           schetscontrol.Schets.SaveBitmap);
  }
