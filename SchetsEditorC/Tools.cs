...
public class RechthoekTool : TweepuntTool {
  ...
  public override void Compleet(Graphics g, Point p1, Point p2,
    ...
    s.Schets.AddSketchElement(
        new SchetsElement(ElementType.EmptyRectangle, p1, p2, s.PenKleur));
  }
}
...
public class VolRechthoekTool : RechthoekTool {
  ...
  public override void Compleet(Graphics g, Point p1, Point p2,
                                SchetsControl s) {
    s.Schets.AddSketchElement(
        new SchetsElement(ElementType.FilledRectangle, p1, p2, s.PenKleur));
  }
}
...
public class CirkelTool : TweepuntTool {
  ...
  public override void Compleet(Graphics g, Point p1, Point p2,
                                SchetsControl s) {
    s.Schets.AddSketchElement(
        new SchetsElement(ElementType.EmptyEllipse, p1, p2, s.PenKleur));
  }
}
...
public class VolCirkelTool : CirkelTool {
  ...
  public override void Compleet(Graphics g, Point p1, Point p2,
                                SchetsControl s) {
    s.Schets.AddSketchElement(
        new SchetsElement(ElementType.FilledEllipse, p1, p2, s.PenKleur));
  }
}
...
public class LijnTool : TweepuntTool {
  ...
  public override void Compleet(Graphics g, Point p1, Point p2,
                                SchetsControl s) {
    s.Schets.AddSketchElement(
        new SchetsElement(ElementType.Line, p1, p2, s.PenKleur));
  }
}
...
public class GumTool : ISchetsTool {
  ...
  public void MuisLos(SchetsControl s, Point p) {
    for (LinkedListNode<SchetsElement> node = s.Schets.sketchElements.Last;
      ...
      if (p.X >= el.bounds.Left && p.Y >= el.bounds.Top &&
          p.X <= el.bounds.Right && p.Y <= el.bounds.Bottom) {
...
public class SchetsElement {
  ...
  public SchetsElement(ElementType type, Point beginPunt, Point eindPunt,
                       Color kleur, string? text = null) {
    this.type = type;
