...
public class VolRechthoekTool : RechthoekTool {
  ...
  public override void Compleet(Graphics g, Point p1, Point p2,
    ...
    s.Schets.AddSketchElement(
        new SchetsElement(path, p1, p2, s.PenKleur, null, true));
  }
}
...
public class PenTool : ISchetsTool {
  ...
  public void Compleet(SchetsControl s, Point p) {
    s.Schets.sketchElements.AddLast(
        new SchetsElement(path, startpunt, p, s.PenKleur, null, false, true));
  }
}
...
public class SchetsElement {
  ...
  public SchetsElement(GraphicsPath path, Point beginPunt, Point eindPunt,
                       Color kleur, string? text = null, bool isFilled = false,
